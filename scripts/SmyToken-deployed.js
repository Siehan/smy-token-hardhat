...
const FILE_PATH = './SmyToken-deployed.json';
/*
...
exports.deployed = async (contractName, networkName, address) => {
  console.log(chalk.yellow.bold(`${contractName} deployed on ${networkName} at ${address}`));
  console.log(chalk.yellow(`updating ${FILE_PATH} with ${contractName} on ${networkName} at ${address}`));
